...
export function createSessionHooks(args: {
  ...
  const gitDiffInjector = safeHook("git-diff-injector" as HookName, () =>
    createGitDiffInjectorHook({ directory: ctx.directory }),
  );

  const costTracker = safeHook("cost-tracker" as HookName, () =>
    createCostTrackerHook(),
  );
